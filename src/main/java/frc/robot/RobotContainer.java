...
public class RobotContainer {
  ...
  // Assumes a Xbox Controller for the driver is into channnel 0
  ...
  private void configureButtonBindings() {
    ...
    onboardButtonA
        .onTrue(new PrintCommand("onboard Button A Pressed"))
        .onFalse(new PrintCommand("onboard Button A Released"));

    // Xbox controller buttons/triggers
    m_driverController.a().onTrue(new InstantCommand(() -> System.out.println("A button pressed")))
